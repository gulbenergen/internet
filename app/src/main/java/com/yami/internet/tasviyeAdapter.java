...
class tasviyeAdapter extends RecyclerView.Adapter<tasviyeAdapter.ViewHolder> {
    ...
    public tasviyeAdapter(String[] title, int[] id, boolean[] action){
        this.Title = title;
        this.idd = id;
        this.actt=action;
    }
    ...
    @Override
    public tasviyeAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewtype) {
